...
function Test-Prerequisites {
    ...
    if (-not (Test-Path $Script:Config.ConfigDirectory )) {
        Write-StatusMessage "Assets directory not found: $($Script:Config.ConfigDirectory )" -Type "ERROR"
        return $false
    }
...
function Get-AllPackages {
    ...
    $wingetPath = Join-Path $Script:Config.ConfigDirectory  $Script:Config.WingetJsonFile
    ...
    $chocoPath = Join-Path $Script:Config.ConfigDirectory  $Script:Config.ChocoJsonFile
