...
[System.Windows.MessageBox]::Show(
    "To install your desired cursors:`n`n1. In the opened folder, right-click the 'install' file and select 'Install'.`n2. Follow any prompts to complete installation.",
